        ...
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div class="grid md:grid-cols-2 items-center gap-6 max-w-6xl w-full">
                <div
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6" id="loginForm">
                        ...
                        <div class="flex justify-center space-x-3 items-center mb-6">
                            <img src="{{ asset('images/logupdated.png') }}" class="h-16 w-16" alt="Logo 1" />
                            <img src="{{ asset('images/SKSU.jpg') }}" class="h-16 w-16" alt="Logo 2" />
                        </div>

                        <!-- Welcome Text -->
                        <div class="mb-6 text-center">
                            <h3 class="text-gray-800 text-3xl font-bold">Welcome Faculty</h3>
                            <p class="text-gray-500 text-sm mt-2">Log In to your Account</p>
                        </div>
                        ...
                        <div class="mt-6">
                            <button type="submit"
                                class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none">
                                Sign in
                            </button>
                        </div>
                    </form>
                    ...
                    <div class="flex justify-center mt-4">
                        <a href="{{ route('auth.google') }}"
                            class="flex items-center justify-center space-x-2 px-4 py-2 border border-gray-300 rounded-lg shadow-md text-gray-700 hover:bg-gray-100 w-full">
                            <img src="{{ asset('images/google.png') }}" alt="Google Logo" class="h-5 w-5">
                ...
                <div class="max-md:mt-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="809.67538" height="462.57748"
                        viewBox="0 0 809.67538 462.57748" xmlns:xlink="http://www.w3.org/1999/xlink" role="img"
                        artist="Katerina Limpitsouni" source="https://undraw.co/">
                        <path d="M328.25,429.03874v-130a7,7,0,1,1,14,0v130a7,7,0,0,1-14,0Z"
                            transform="translate(-195.16231 -218.71126)" fill="#f0f0f0" />
                        <path d="M311.5,429.03874v-130a7,7,0,1,1,14,0v130a7,7,0,0,1-14,0Z"
                            transform="translate(-195.16231 -218.71126)" fill="#f0f0f0" />
                        <path d="M294.75,429.03874v-130a7,7,0,1,1,14,0v130a7,7,0,0,1-14,0Z"
                            transform="translate(-195.16231 -218.71126)" fill="#f0f0f0" />
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#e6e6e6" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#f2f2f2" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#cacaca" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#ccc" />
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#e4e4e4" />
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#3f3d56" />
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#fff" />
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#9e616a" />
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#e4e4e4" />
                        <ellipse cx="668.67452" cy="246.33609" rx="48.7906" ry="15.89806" fill="#cacaca" />
                        <polygon
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#2f2e41" />
                        <polygon
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#e4e4e4" />
                        <circle cx="862.94934" cy="260.49201" r="25.25457"
                            transform="translate(2.9207 650.45999) rotate(-59.27092)" fill="#9e616a" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#037706" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#ffb6b6" />
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#037706" />
                        <rect x="420.33638" y="585.87873" width="32.05245" height="53.1155"
                            transform="translate(677.56291 1006.16171) rotate(-180)" fill="#cacaca" />
                        <rect x="483.52534" y="596.633" width="7.3266" height="92.96452"
                            transform="translate(-513.69292 466.43358) rotate(-55.84051)" fill="#cacaca" />
                        <rect x="339.05431" y="639.45196" width="92.96452" height="7.3266"
                            transform="translate(-489.75804 108.72104) rotate(-34.15969)" fill="#cacaca" />
                        ...
                        <rect x="237.07927" y="398.30415" width="7.32628" height="52.19971" fill="#cacaca" />
                        <rect x="429.49422" y="539.17373" width="13.73677" height="70.5154"
                            transform="translate(677.56291 930.1516) rotate(-180)" fill="#cacaca" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-195.16231 -218.71126)" fill="#2f2e41" />
                        <circle cx="466.43293" cy="305.08477" r="33.99544"
                            transform="translate(-133.45157 469.56581) rotate(-76.6227)" fill="#ffb8b8" />
                        <path
